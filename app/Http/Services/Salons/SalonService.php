...
class SalonService
{
    ...
    public function show($id)
    {
        ...
        $salon->load(['socialMediaSites', 'images', 'workingHours', 'owner', 'latestReviews', 'loyaltyService', 'myLoyaltyPoints.freeService', 'myLoyaltyPoints.user', 'myLoyaltyPoints.salon']);
